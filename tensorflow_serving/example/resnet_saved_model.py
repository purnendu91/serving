...
tf.app.flags.DEFINE_string('output_dir', '/tmp/resnet_output',
...
def export():
  ...
  with tf.Graph().as_default():
    ...
    with slim.arg_scope(resnet_v1.resnet_arg_scope()):
      net, end_points = resnet_v1.resnet_v1_50(input_tensor, 1000, is_training=False)
    ...
    with tf.Session() as sess:
      ...
      saver.restore(sess, os.path.join(pre_trained_model_dir, "resnet_v1_50.ckpt"))
      ...
      predict_inputs_tensor_info = tf.saved_model.utils.build_tensor_info(input_tensor)
